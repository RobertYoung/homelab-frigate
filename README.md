...
Ansible project for deploying [Frigate](https://github.com/blakeblackshear/frigate) via Docker Compose on a single host.

**Target host:** `frigate.local.iamrobertyoung.co.uk`
...
├── inventories/
│   ├── hosts.yml               # Inventory with frigate group
│   └── group_vars/             # Group variables
├── host_vars/                  # Host-specific variables
├── roles/
│   └── frigate/                # Custom Frigate role
...
| `frigate` | Custom | Frigate deployment |
